...
import ru.scheduler.users.exceptions.StorageException;
import ru.scheduler.users.exceptions.StorageFileNotFoundException;
...
public class FileSystemStorageService implements StorageService {
    ...
    public Resource loadAsResource(String filename) {
        try {
            ...
            throw new StorageFileNotFoundException("Mailformed Could not read file: " + filename, e);
        }
    }
